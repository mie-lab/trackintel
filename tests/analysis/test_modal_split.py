...
def test_triplegs_modal_split(ls_short, ls_long):
    ...
    list_dict = [{'id': 0, 'user_id': 0, 'started_at': day_1_h1, 'finished_at': day_1_h1 + one_hour,
                  'geometry': ls_short, 'mode': 'car'},
                 {'id': 1, 'user_id': 0, 'started_at': day_1_h2, 'finished_at': day_1_h2 + one_min, 'geometry': ls_long,
                  'mode': 'bike'},
                 {'id': 2, 'user_id': 0, 'started_at': day_2_h1, 'finished_at': day_2_h1 + one_hour,
                  'geometry': ls_short,
                  'mode': 'walk'},
                 {'id': 3, 'user_id': 0, 'started_at': day_8_h1, 'finished_at': day_8_h1 + one_hour,
                  'geometry': ls_short,
                  'mode': 'walk'},
                 {'id': 4, 'user_id': 1, 'started_at': day_1_h1, 'finished_at': day_1_h1 + one_hour,
                  'geometry': ls_long,
                  'mode': 'walk'},
                 {'id': 5, 'user_id': 1, 'started_at': day_1_h2, 'finished_at': day_1_h2 + one_hour,
                  'geometry': ls_long,
                  'mode': 'walk'}]
