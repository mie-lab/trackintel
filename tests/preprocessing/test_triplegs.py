...
class TestGenerate_trips:
    ...
    def test_generate_trips_missing_link(self):
        ...
        # generate trips and a joint staypoint/triplegs dataframe
        stps, tpls, _ = ti.preprocessing.triplegs.generate_trips(stps, tpls, gap_threshold=15, id_offset=0)
    ...
    def test_generate_trips_dtype_consistent(self):
        ...
        # generate trips and a joint staypoint/triplegs dataframe
        stps, tpls, trips = ti.preprocessing.triplegs.generate_trips(stps, tpls, gap_threshold=15, id_offset=0)
    ...
    def test_generate_trips_index_start(self):
        ...
        # generate trips and a joint staypoint/triplegs dataframe
        _, _, trips = ti.preprocessing.triplegs.generate_trips(stps, tpls, gap_threshold=15, id_offset=0)
    ...
    def test_generate_trips_gap_detection(self):
        ...
        # generate trips and a joint staypoint/triplegs dataframe
        stps_proc, tpls_proc, trips = ti.preprocessing.triplegs.generate_trips(
            stps_in, tpls_in, gap_threshold=15, id_offset=0
        )
