...
class TestSpatial_filter:
    def test_filter_staypoints(self):
        ...
        assert all(within_spts.geometry == intersects_spts.geometry), (
            "For sp the result of within and" + "intersects should be the same"
        )
    ...
    def test_filter_locations(self):
        ...
        assert all(within_loc.geometry == intersects_loc.geometry), (
