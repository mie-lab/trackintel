...
- Three types of benchmarks exist (sample at [benchmarks](https://github.com/mie-lab/trackintel/tree/master/benchmarks) folder))
  - _mem__ which measures the memory of the data structure returned:
    https://github.com/mielab/trackintel/blob/19fcf965fce4a2bca2032f72b2759c7625c02b2f/benchmarks/preprocessing_benchmarks.py#L27

  - _peakmem_ which measure the peak memory usage:
    https://github.com/mielab/trackintel/blob/19fcf965fce4a2bca2032f72b2759c7625c02b2f/benchmarks/preprocessing_benchmarks.py#L24
  
  - _time__ which measure run time:
    https://github.com/mielab/trackintel/blob/19fcf965fce4a2bca2032f72b2759c7625c02b2f/benchmarks/preprocessing_benchmarks.py#L21
