...
htmlhelp_basename = "trackinteldoc"
...
latex_documents = [
    (master_doc, "trackintel.tex", "trackintel Documentation", "Dominik Bucher, Henry Martin, Ye Hong", "manual"),
]
...
man_pages = [(master_doc, "trackintel", "trackintel Documentation", [author], 1)]
